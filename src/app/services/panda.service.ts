...
export class PandaService {
   ...
   public getPandas(): Panda[] {
      return this.PANDA_DATA;
   }

   public getPandaById(id: number): Panda | undefined {
      return this.PANDA_DATA.find((panda) => panda.id === id);
   }
}
